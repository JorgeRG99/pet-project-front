  ...
  return (
    <main className="w-full py-16 flex flex-col items-center gap-12">
      ...
      <Tabs
        ...
        className="w-[350px] md:w-[450px] flex flex-col items-center"
      >
        <TabsList className="p-2 h-auto w-full bg-white shadow">
          <TabsTrigger
            className="md:text-xl text-sm font-normal data-[state=active]:text-white data-[state=active]:bg-primary-dark"
            value="profile"
          >
            Perfil
          </TabsTrigger>
